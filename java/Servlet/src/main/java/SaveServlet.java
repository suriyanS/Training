...
message.setContent("<h1>Hi"+firstname+"</h1><br><br><h2>Your Registration Is Succesful</h2><br><br><h3>Event Details:<br><br>Date:"+date+"<br>"+"<br>Time:"+time+"<br>"+"<br>Location:"+location+"<br>","text/html" );
